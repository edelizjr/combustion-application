...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.reboticreg.myapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.reboticreg.myapp.security.DomainUserDetailsService", "createSpringSecurityUser");
